...
<body>
    ...
    <header class="sticky">
        ...
        <div class="container" id="con1">
            <div class="row">
                ...
                <div class="col-7">
                    <a href="#donate" class="btn btn-warning" id="a2">
                        <i class="fa fa-heart-o"></i> &nbsp;DONATE</a>
        ...
        <nav class="navigation">
            ...
            <div class="container" id="con-3">
                ...
                <a href="/home">Home</a>
                    ...
                    <a href="/register" style="float:right ;" id="sign-up">Sign-up</a>
 ...
 <div class="galry" style="height:auto ;">
    <div class="container" id="G1" style="height: auto; background-color: #fff;">
    <div class="row" style="height: auto; margin-top: 10px; margin-bottom: 10px; ">
        <div class="flex-container">
            ...
            <div class="image">
              <img src="gallery-images/4.jpg" alt="image">                                </div>
